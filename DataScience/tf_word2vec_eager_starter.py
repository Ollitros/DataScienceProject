...
from DataScience import tf_word2vec_utils
...
class SkipGramModel:
    ...
    def train(self, num_train_steps):
        ...
        initial_step = 0
        tf_utils.safe_mkdir('checkpoints')
    ...
    def visualize(self, visual_fld, num_visualize):
        ...
        tf_word2vec_utils.most_common_words(visual_fld, num_visualize)
...
def gen():
    yield from tf_word2vec_utils.batch_gen(DOWNLOAD_URL, EXPECTED_BYTES, VOCAB_SIZE,
