...
def resize_image(image_path):
    """
    try to resize the image to the standard CONFIG height and width
    crop assuming rectangle - landscape picture
    """
    ...
    # crop, height has been set by resize
    img = img.crop((0, 0, CONFIG.IMAGE_WIDTH, CONFIG.IMAGE_HEIGHT))
...
def get_images():
    """
    read the content and style image from CONFIG settings
